...
export const ResizableDrawer = observer(function ResizableDrawer({
  ...
  const minWidthPx = typeof minWidth === 'number' ? minWidth : containerWidth * parseInt(minWidth) / 100;
  const maxWidthPx = typeof maxWidth === 'number' ? maxWidth : containerWidth * parseInt(maxWidth) / 100;
  ...
  return (
    <Drawer
      ...
      {...rest}
    >
      <DrawerContent maxWidth={maxWidth} style={{
        width: newWidth,
      }}>
        <chakra.div
